...
#endif
    public class WOF_BetManager : MonoBehaviour
    {
        public static WOF_BetManager Instance;
        ...
        private void Start()
        {
            ...
            WOF_Timer.Instance.onTimeUp += PostBets;
            WOF_Timer.Instance.onCountDownStart += ClearBet;
        }
        void PostBets()
        {
        }
