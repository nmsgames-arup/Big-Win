...
{
    public class PokerKing_Timer : MonoBehaviour
    {
        public static PokerKing_Timer Instance;
        int bettingTime = 15;
        int timeUpTimer = 10;
        int waitTimer = 3;
        ...
        void Start()
        {
            ...
            if(is_a_FirstRound)
            {
                PokerKing_UiHandler.Instance.ShowMessage("please wait for next round...");
            }
        }
        ...
        public void OnTimerStart(object data)
        {
            if (is_a_FirstRound)
            {
                PokerKing_UiHandler.Instance.HideMessage();
            }
        ...
        public void OnCurrentTime(object data = null)
        {
            ...
            try
            {
                ...
                PokerKing_UiHandler.Instance.UpDateBalance(float.Parse(cr.balance));
            }
            catch (Exception e)
            {
                Debug.Log(e.Message);
